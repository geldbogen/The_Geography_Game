...
setup_data("Forest area in 1000 hectars (by 100 km^2) (higher is better).csv",treatmissingdataasbad=True,dif=1)
setup_data("Yearly average temperature in (in Celsius) (higher is better).csv",treatmissingdataasbad=True,dif=2)
setup_data("Annual precipiation (in mm) (higher is better).csv",treatmissingdataasbad=True,dif=2)
setup_data("Number of different established languages and dialects (higher is better).csv",treatmissingdataasbad=True,dif=3) #was ist eine Sprache
...
setup_data("Percentage of prisoners being female (higher is better).csv",treatmissingdataasbad=True,dif=5)
...
setup_data("Percentage of alcohol being consumed is wine (higher is better).csv",treatmissingdataasbad=True,dif=3) #genauer 
setup_data("Percentage of alcohol being consumed is beer (higher is better).csv",treatmissingdataasbad=True,dif=3) #genauer
...
setup_data("Fishing in tons (by 1000 population) (higher is better).csv",treatmissingdataasbad=True,dif=2)
setup_data("Garlic production in tons  (by 10,000 population) (higher is better).csv",treatmissingdataasbad=True,dif=4,cluster="productioncluster")
setup_data("Soybean production in tons (by 10,000 population) (higher is better).csv",treatmissingdataasbad=True,dif=4,cluster="productioncluster")
setup_data("Tomato production in tons (by 100 population) (higher is better).csv",treatmissingdataasbad=True,dif=3,cluster="productioncluster")
setup_data("Pineapple production in tons (by 1000 population) (higher is better).csv",treatmissingdataasbad=True,dif=3,cluster="productioncluster")
setup_data("Plum production in tons (by 1000 population) (higher is better).csv",treatmissingdataasbad=True,dif=4,cluster="productioncluster")
setup_data("Grape production in tons (by 100 population) (higher is better).csv",treatmissingdataasbad=True,dif=4,cluster="productioncluster")
setup_data("Eggplant production in tons (by 1000 population) (higher is better).csv",treatmissingdataasbad=True,dif=4,cluster="productioncluster")
setup_data("Cherry production in tons (by 1000 population) (higher is better).csv",treatmissingdataasbad=True,dif=4,cluster="productioncluster")
setup_data("Wine production in tons (by 100 population) (higher is better).csv",treatmissingdataasbad=True,dif=4,cluster="productioncluster")
setup_data("Coffee production in tons (by 1000 population) (higher is better).csv",treatmissingdataasbad=True,dif=3,cluster="productioncluster")
setup_data("Cucumber production in tons (by 1000 population) (higher is better).csv",dif=4,cluster="productioncluster")
setup_data("Coconut prodcution in tons  (by 1000 population) (higher is better).csv",treatmissingdataasbad=True,dif=4,cluster="productioncluster")
setup_data("Apricot production in tons (by 1000 population) (higher is better).csv",treatmissingdataasbad=True,dif=4,cluster="productioncluster")
setup_data("Barley production in tons (by 100 population) (higher is better).csv",treatmissingdataasbad=True,dif=4,cluster="productioncluster")
setup_data("Potato production in tons (by 100 population) (higher is better).csv",treatmissingdataasbad=True,dif=4,cluster="productioncluster")
setup_data("Apple production in tons (by 100 population) (higher is better).csv",treatmissingdataasbad=True,dif=3,cluster="productioncluster")
setup_data("Fishing in tons (by 1000 population) (higher is better).csv",treatmissingdataasbad=True,dif=4,cluster="productioncluster")
setup_data("Industrial production growth rate 2017 in percent (higher is better).csv",dif=4) #erklären
setup_data("Minimum wage PPP-adjusted in Int$ (higher is better).csv",treatmissingdataasbad=True,dif=2) #was ist PPP
setup_data("Meat consumption in kg per year and person (lower is better).csv",dif=2,ascending=True)

setup_data("Irrigated area (by 100 km^2 country size) (higher is better).csv",treatmissingdataasbad=True,dif=3,cluster="productioncluster")
...
setup_data("Chess grandmasters per capita (higher is better).csv",treatmissingdataasbad=True,dif=4)
...
setup_data("Percentage of people using the internet (higher is better).csv",treatmissingdataasbad=True,dif=2)
...
setup_data("Number of mcdonalds restaurants (by 1,000,000 population) (higher is better).csv",treatmissingdataasbad=True,dif=2)
...
setup_data("Size of largest island in km2 (higher is better).csv",treatmissingdataasbad=True,dif=1)
setup_data("Number of UNESCO World Heritage Sites (higher is better).csv",treatmissingdataasbad=True,dif=2)
...
setup_data("Number of visits by an US-President (since formation of the country) (higher is better).csv",dif=2,treatmissingdataasbad=True)
setup_data("Home ownership rate (higher is better).csv",dif=2)
setup_data("Number of wiki-languages of most famous person from that country (higher is better).csv",dif=1,additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous architect of that country (higher is better).csv",dif=2,additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of urban areas with more than 1 mio. citizens (higher is better).csv",dif=1)
setup_data("Number of twitter followers of head of state resp. head of government (higher is better).csv",dif=1,additional_information=True,additional_information_column=[2,3,4])
...
setup_data("Number of airports (higher is better).csv",treatmissingdataasbad=True,dif=2)
setup_data("Number of airports (by 1,000,000 population) (higher is better).csv",treatmissingdataasbad=True,dif=3)
setup_data("Number of wiki-languages of head of state resp. head of government (higher is better).csv",dif=2,additional_information=True,treatmissingdataasbad=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous band from that country (higher is better).csv",dif=3,additional_information=True,treatmissingdataasbad=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous food from that country (higher is better).csv",treatmissingdataasbad=True,dif=1,additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous actor from that country (higher is better).csv",dif=2,treatmissingdataasbad=True,additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous singer of that country (higher is better).csv",additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous person from that country, who is still alive (higher is better).csv",dif=2,treatmissingdataasbad=True,additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous touristic sight of that country (higher is better).csv",treatmissingdataasbad=True,dif=1,additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous woman from that country (higher is better).csv",treatmissingdataasbad=True,dif=3,additional_information=True,additional_information_column=[2,3,4])
setup_data("Facebook accounts (by 10 population) (higher is better).csv",treatmissingdataasbad=True,dif=2)
...
setup_data("Number of wiki-languages of most famous city with at most 5000 citizens (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous city with at most 20,000 citizens (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous city with at most 100,000 citizens (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous historical person (at least 50 years dead) (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous historical person (at least 100 years dead) (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous historical person (at least 200 years dead) (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous historical person (at least 500 years dead) (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Literacy rate (higher is better).csv")
setup_data("Number of wiki-languages of most famous one-day historic event at least 90 years ago (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Highest building of that country in meter (higher is better).csv",additional_information=True,additional_information_column=[2,3,4],dif=3)
setup_data("Number of wiki-languages of most famous scientist of that country (higher is better).csv",additional_information=True,additional_information_column=[2,3,4],treatmissingdataasbad=True)
setup_data("Minimum number of paid annual vacation (higher is better).csv")
setup_data("Number of wiki-languages of most famous writer of that country (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Median age (lower is better).csv",ascending=True)
setup_data("Number of wiki-languages of most famous one-day historic event in the 21st century (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous one-day historic event at least 200 years ago (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous one-day historic event (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Size of the lower house (or equivalent) of that country (higher is better).csv")
setup_data("Person of that country with the most social media follower (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
...
setup_data("Number of wiki-languages of the capital (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
...
setup_data("Highest mountain of that country (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
...
setup_data("Oil production in barrel per year (by 1000 population) (higher is better).csv",treatmissingdataasbad=True)
...
setup_data("Number of wiki-languages of most famous soccer player (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
...
setup_data("Number of wiki-languages of most famous fashion person of that country (higher is better).csv",additional_information=True,treatmissingdataasbad=True,additional_information_column=[2,3,4])
...
setup_data("Number of wiki-languages of most famous geographical feature of that country (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous one-day event between 1950 and 2000 (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous city with at most 500,000 citizens (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous city with at most 1,000,000 citizens (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous (real) building of that country (higher is better).csv",additional_information=True,additional_information_column=[2,3,4],)
setup_data("Number of wiki-languages of most famous architectural structure of that country (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
...
setup_data("Number of speakers of most spoken official language of that country (higher is better).csv",additional_information=True,additional_information_column=[2])
setup_data("Number of wiki-languages of most famous painter of that country (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Population of the most populated city of that country (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])    
setup_data("Population of the second most populated city of that country (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])    
setup_data("Population of the third most populated city of that country (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])    
setup_data("Sum of the three most populated cities of that country (higher is better).csv")
setup_data("Number of wiki-languages of most famous city of that country (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of second most famous city of that country (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of third most famous city of that country (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Sum of wiki-languages of the three most famous cities of that country (higher is better).csv")
setup_data("Number of wiki-languages of most famous company which is neither an airline nor a national bank (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of mentions of that countrys name in the NYT from 2000 to 2016 (higher is better).csv")
setup_data("Number of wiki-languages of most famous airline of that country (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
...
setup_data("Number of wiki-languages of most famous newspaper of that country (higher is better).csv",additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous street - avenue - boulevard of that country (higher is better).csv",additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous road - highway - motor circuit of that country (higher is better).csv",additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous bridge of that country (higher is better).csv",additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous place of worship (church,mosque,temple etc.) of that country (higher is better).csv",additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous (real) museum of that country (higher is better).csv",additional_information=True,additional_information_column=[2,7,8])
...
setup_data("Number of wiki-languages of most famous athlete of that country which is not a soccer player (higher is better).csv",additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous criminal of that country (higher is better).csv",additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous health scientist of that country (higher is better).csv",additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous movie director of that country (higher is better).csv",additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous person from that country born after 2000 (higher is better).csv",additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous social scientist humanities scholar of that country (higher is better).csv",additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous cleric of that country (higher is better).csv",additional_information=True,treatmissingdataasbad=True,additional_information_column=[2,3,4])
...
setup_data("Natural gas production (in million m^3 per year) (by 10,000 population) (higher is better).csv",treatmissingdataasbad=True)
...
setup_data("S&P credit rating (better rating is better) (lower is better).csv",ascending=True,additional_information=True,additional_information_column=[2])
setup_data("Amount of currencies one US$ can buy (higher is better).csv",additional_information=True,additional_information_column=[2,3,4])
...
setup_data("Number of tanks (by 10,000,000 population) (higher is better).csv",treatmissingdataasbad=True)
setup_data("Number of military ships (by 100,000,000 population) (higher is better).csv",treatmissingdataasbad=True)
setup_data("Number of military aricrafts (by 10,000,000 population) (higher is better).csv",treatmissingdataasbad=True)
setup_data("National Holiday (earlier in the year is better).csv",ascending=True,additional_information=True,additional_information_column=[2,3,4])
setup_data("Number of wiki-languages of most famous desert of that country (higher is better).csv",dif=2,treatmissingdataasbad=True,additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous airport of that country (higher is better).csv",dif=2,treatmissingdataasbad=True,additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous national park - garden - zoo in that country (higher is better).csv",dif=2,treatmissingdataasbad=True,additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous historical woman (at least 50 years dead) of that country (higher is better).csv",dif=2,treatmissingdataasbad=True,additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous historical woman (at least 100 years dead) of that country (higher is better).csv",dif=2,treatmissingdataasbad=True,additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous historical woman (at least 200 years dead) of that country (higher is better).csv",dif=2,treatmissingdataasbad=True,additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous historical woman (at least 500 years dead) of that country (higher is better).csv",dif=2,treatmissingdataasbad=True,additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous historical woman (at least 500 years dead) of that country (higher is better).csv",dif=2,treatmissingdataasbad=True,additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous historical woman (at least 500 years dead) of that country (higher is better).csv",dif=2,treatmissingdataasbad=True,additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous historical woman (at least 500 years dead) of that country (higher is better).csv",dif=2,treatmissingdataasbad=True,additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous female scientist of that country (higher is better).csv",dif=2,treatmissingdataasbad=True,additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous female athlete of that country (higher is better).csv",dif=2,treatmissingdataasbad=True,additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous female actor of that country (higher is better).csv",dif=2,treatmissingdataasbad=True,additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous battle which took place in that country (higher is better).csv",dif=2,treatmissingdataasbad=True,additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous woman being born after 2000 (higher is better).csv",dif=2,treatmissingdataasbad=True,additional_information=True,additional_information_column=[2,7,8])
setup_data("Number of wiki-languages of most famous female singer of that country (higher is better).csv",dif=2,treatmissingdataasbad=True,additional_information=True,additional_information_column=[2,7,8])
