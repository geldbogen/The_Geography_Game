...
countries_alternative_names={\
    ...
    "Republic of the Congo":["Congo (Brazzaville)","Congo","Republic of the Congo","Congo, Republic of the","Congo, Republic of"],\
    "Democratic Republic of the Congo":["Congo-Kinshasa","DR Congo *","Dr Congo","Congo DR","DR Congo *","Congo (Kinshasa)","DR Congo","Democratic Republic of Congo","Congo, Democratic Republic of the","Congo, Democratic Republic of"],\
    ...
    "Trinidad and Tobago":["Trinidad/Tob.","Trinidad and Tobago","Trinidad & Tobago"],\
    ...
    "United States":["the United States","US","United States of America"],\
...
class Country:
    def __init__(self,xcoordinate,ycoordinate,name,continent=None):
        ...
        self.wormholecoordinates=[xcoordinate[0],ycoordinate[0]]
...
bettersetupdata("vehicles per 1000 population (higher is better).csv",treatmissingdataasbad=True,dif=2)
...
bettersetupdata("strength of passport (in countries enterable without need of visa) (higher is better).csv",treatmissingdataasbad=True,dif=2,additional_information=True,additional_information_column=[2,3,4])
...
bettersetupdata("number of different established languages and dialects (higher is better).csv",treatmissingdataasbad=True,dif=3)
bettersetupdata("first use of current flag (older is better).csv",ascending=True,dif=4)
bettersetupdata("Gender Gap Index (more equal is better).csv",dif=2)
...
bettersetupdata("percentage of alcohol being consumed is wine (higher is better).csv",treatmissingdataasbad=True,dif=3)
bettersetupdata("percentage of alcohol being consumed is beer (higher is better).csv",treatmissingdataasbad=True,dif=3)
bettersetupdata("alcohol consumption per person per year (lower is better) (in l).csv",ascending=True,dif=2)
...
bettersetupdata("industrial production growth rate 2017 in percent (higher is better).csv",dif=4)
bettersetupdata("minimum wage PPP-adjusted in Int$ (higher is better).csv",treatmissingdataasbad=True,dif=2)
...
bettersetupdata("perception of corruption score (less corrupt is higher) (higher is better).csv",dif=2)
bettersetupdata("generosity score (higher is better).csv",dif=2)
bettersetupdata("freedom to make life choices score (higher is better).csv",dif=2)
bettersetupdata("healthy life expectancy score (higher is better).csv",dif=2)
bettersetupdata("social support score (higher is better).csv",dif=2)
...
bettersetupdata("Mobile phone subscriptions (per 100 people) (higher is better).csv")
