...
from globalDefinitions import resizeRatio, preAllCountries, countriesForLanguageEn
...
class Country:
    def __init__(self,xcoordinate,ycoordinate,name,continent=None):
        ...
        self.wormholecoordinates=[resizeRatio[0]* xcoordinate[0],resizeRatio[1]*ycoordinate[0]]
