...
# df1=pd.DataFrame(data={0:["Apfel"],1:["gesund"],2:[0.5]})
# df2=pd.DataFrame(data={0:["Cola"],1:["ungesund"],2:[2]})
# print(df1)
# print(df2)
# df1.to_csv("trash_1.csv",index=False)
# df2.to_csv("trash_2.csv",index=False)
# df1=pd.read_csv("trash_1.csv")
# df2=pd.read_csv("trash_2.csv")
# df1=df1.append(df2,ignore_index=True)
# print("\n\n\n\n")

# print(df1)
# mywikisite=wikipedia.page(pageid="43114413")
# print(mywikisite.url)
# -*- coding: utf-8 -*-
...
# path = 'map/worldmap4.jpg'  # place path to your image here
# root = tk.Tk()
# app = Zoom_Advanced(root, path=path)

# mydata=pd.DataFrame({"age":[18,22],"money":[20,50]})
