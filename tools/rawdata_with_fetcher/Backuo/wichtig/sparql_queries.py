...
def fetchitems(itemname,errorlist_index=False,errorlist_timeout=False):
    ...
    for item in sparqllist:
        ...
        try:
            ...
            wd:Q4504549 ^wdt:P279*/^wdt:P106 ?novelist
...
read_errorlists("buildings_by_countries_most_famous_religious_servant") 
fetchitems("buildings_by_countries_most_famous_religious_servant",errorlist_timeout=True)
